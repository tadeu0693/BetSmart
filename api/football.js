export default async function handler(req, res) {
  ...
  if (!apiKey) return res.status(500).json({ error: "RAPIDAPI_KEY não configurada. Vá em Vercel > Settings > Environment Variables, adicione RAPIDAPI_KEY e marque os 3 ambientes (Production, Preview, Development), depois faça Redeploy." });
